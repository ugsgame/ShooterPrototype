...
#include "SoundNodeVehicleEngine.h"

#include "SoundDefinitions.h"
#include "Player/ShooterPlayerController.h"
#include "Player/ShooterVehicle.h"
...
void USoundNodeVehicleEngine::StoreCurrentRPM(FAudioDevice* AudioDevice, FActiveSound& ActiveSound, const FSoundParseParameters& ParseParams, float MaxRPM)
{
	...
	AShooterVehicle::FVehicleDesiredRPM DesiredRPM;
	if (AShooterVehicle::GetVehicleDesiredRPM_AudioThread(ActiveSound.GetOwnerID(), DesiredRPM))
	{
