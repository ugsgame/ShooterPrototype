...
{
	static ConstructorHelpers::FClassFinder<APawn> PlayerPawnOb(TEXT("/Game/Prototype/Blueprints/Pawns/PlayerPawn"));
	DefaultPawnClass = PlayerPawnOb.Class;
	
	static ConstructorHelpers::FClassFinder<APawn> BotPawnOb(TEXT("/Game/Prototype/Blueprints/Pawns/BotPawn"));
...
{	
	if (AIController)
	{
		if (AIController->PlayerState)
		{
			...
			AIController->PlayerState->GetPlayerName() = BotName;
		}		
	}
}
