...
EShooterPlayerType AShooterPlayerController::GetPlayerType() const
{
	return PlayerType;
}
...
bool AShooterPlayerController::IsHandbrakeForced() const
{
	return bHandbrakeOverride;
}

void AShooterPlayerController::SetHandbrakeForced(bool bNewForced)
{
...
void AShooterPlayerController::ChangePlayerType(EShooterPlayerType ePlayerType)
{
	AShooterCharacter* ShooterChar = Cast<AShooterCharacter>(GetCharacter());
	if (ShooterChar)
	{
		ShooterChar->OnChangePlayerType(ePlayerType);
