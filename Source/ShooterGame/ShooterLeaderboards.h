 ...
 */
class SHOOTERGAME_API FShooterAllTimeMatchResultsRead : public FOnlineLeaderboardRead
{
public:
 ...
 */
class SHOOTERGAME_API FShooterAllTimeMatchResultsWrite : public FOnlineLeaderboardWrite
{
public:
