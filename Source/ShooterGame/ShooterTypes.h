...
/** player type*/
UENUM(BlueprintType)
enum class EShooterPlayerType :uint8
{
	FPS,			//Fist Person Shooter Player 
	TPS,			//Third Person Shooter Player
	TSS,			//Twin Stick Shooter Player
	VRS				//VR Shooter Player
};
...
#define SHOOTER_SURFACE_Gravel		SurfaceType9
