...
public:
	...
	{
		static const FName LoadingScreenName(TEXT("/Game/Prototype/UI/Menu/LoadingScreen.LoadingScreen"));
...
public:
	...
	{		
		...
		LoadObject<UObject>(NULL, TEXT("/Game/Prototype/UI/Menu/LoadingScreen.LoadingScreen") );
